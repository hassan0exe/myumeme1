...
(function($) {
	...
	$.alerts = {
		...
		_show: function(title, msg, value, type, callback) {
			if(Lang=='A'){
				$.alerts.okButton='موافق';
				$.alerts.cancelButton='إلغاء';
			}
			$.alerts._hide();
			...
			$.alerts._maintainPosition(true);
				...
				switch( type ) {
				case 'alert':
					$("#popup_message").after('<div id="popup_panel"><input type="button" class="button-a blue" value="' + $.alerts.okButton + '" id="popup_ok" /></div>');
